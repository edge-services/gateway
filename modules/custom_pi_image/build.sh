...
cat > config <<EOL
export IMG_NAME=hukam-edge-raspbian
export RELEASE=buster
export DEPLOY_ZIP=1
export LOCALE_DEFAULT=en_US.UTF-8
export TARGET_HOSTNAME=hukam-edge-raspbian
export KEYBOARD_KEYMAP=us
export KEYBOARD_LAYOUT="English (US)"
export TIMEZONE_DEFAULT=Asia/Kolkata
export FIRST_USER_NAME=hukam
export FIRST_USER_PASS="${pi_pwd}"
export ENABLE_SSH=1
export WPA_ESSID=hukam
export WPA_PASSWORD=1SatnamW
export WPA_COUNTRY=IN
EOL
